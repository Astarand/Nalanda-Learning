        ...
        <div className="container">
          <div className="header__main">
            <Link href="/" className="logo">
              <Image src="/images/logo/logo.png" alt="logo" width={110} height={65} />
            </Link>
            <div className="main-menu">
              <nav>
                <ul>
                  ...
                  <li>
                    <Link href="/services">
                      Our Solutions <i className="fa-solid fa-angle-down"></i>
                    </Link>
          ...
          <div className="sidebar__contact-info mt-30">
            ...
            <ul>
              <li>
                ...
                <a href="#">
                  AE-013, Canal Side Rd, A.E. Block sector 1, AE Block, Sector 1, Bidhannagar,
                  Kolkata, West Bengal 700064
                </a>
              </li>
              <li className="py-2">
                <i className="fa-solid fa-phone-volume" />{' '}
                <a href="tel:+9118002033015">+91-18002033015</a>
              </li>
              <li className="mb-2">
